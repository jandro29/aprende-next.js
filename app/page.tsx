            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 relative z-10">
                ...
                <p className="text-xl text-neutral-700 mb-8 max-w-lg animate-in slide-in-from-left duration-700 delay-200">
                  Domina herramientas de IA generativa como ChatGPT, Gemini y
                  NotebookLM para convertirte en un referente en ventas B2B.
                  Aprende con expertos en inteligencia artificial y ventas
                  industriales.
                </p>
